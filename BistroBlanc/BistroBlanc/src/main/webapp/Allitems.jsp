<%@ include file="header.jsp" %>
    <div class="container   p-2 mt-5" >
        <h1 class="text-danger">Explore Our All Food Items</h1>
                    ...
                    <img src="AllFoodItems/${food.img_url}" alt="${food.item_name}" class="img-fluid rounded-5 mx-auto mt-2 d-block" width="200" height="auto">
                    	<div class="card_content">
                        	...
                        	<div class="d-flex gap-0 column-gap-3">
                         		<a href="login"><button  type="submit" class="btn align-self-start btn-primary">Buy Now</button></a>
                        		<a href="cartItems?item_id=${food.item_id}" class="link-underline-light link-dark link-underline-opacity-0 link-offset-3-hover link-offset-2 "><button  type="submit" class="btn align-self-start btn-warning">Add Order</button></a>
                       	 	</div>    
                         </div>
